...
<body>
	...
	<nav aria-label="Page navigation example">
  		<ul class="pagination justify-content-center">
    		...
    		startPage브타 endPage까지의 숫자들이 버튼으로 나열되게 만들어주세요.
    		begin, end에 따른 루프 바퀴에 따른 변수명에 var속성으로 지정합니다.
	...
	작성은 해뒀지만 css의 display를 none으로 평상시에 두고
	특정한 요건을 만족했을때만 display를 허용하도록 설계외어있습니다.
	그래서 아해와 같이 모달 예시코드를 붙여넣어도
	일반 화면에서는 보이지 않습니다.-->
...
<!-- 부트스트랩용 JS파일도 마저 임포트 코드 진행 순서가 위에서 아래이므로
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-/bQdsTh/da6pkI1MST/rWKFNjaCP5gBSY4sEBT38Q/9RBh9AH40zEOg7Hlq2THRZ" crossorigin="anonymous"></script>
	...
	<script>
		...
		var bno = "${bno}";
		// 모달 사용을 위한 변수 선언
		// 모달 공식문서의 자바스크립트 관한 실행 코드를 복사합니다.
